...
from cuentas.views import ConsultaUltimosMovView, ConsultaDeudasView, UserDeleteView, CtaCteDeleteView, CtaCteDetailsView, CtaCteUpdateView, CtaCteMenuView, UserMenuView, UserUpdateView, UserRegistrationView, HomeView, TemplateView, NewCuentaCorrienteView
...
urlpatterns = [
    ...
    url(r'^eliminar/(?P<pk>\d+)/$', UserDeleteView.as_view(), name='user_delete'),
    ...
    url(r'^eliminar/(?P<pk>\d+)/$', CtaCteDeleteView.as_view(), name='ctacte_delete'),
